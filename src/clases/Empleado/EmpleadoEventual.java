...
public class EmpleadoEventual extends Empleado {
    ...
    public void registrarDatos() {
        ...
        honorariosPorHora= Double.parseDouble(JOptionPane.showInputDialog("Integre el salario mensual"));
        fechaTerminoContrato= JOptionPane.showInputDialog("Ingrese la fecha de nacimiento(dd/mm/aa)");
    }
